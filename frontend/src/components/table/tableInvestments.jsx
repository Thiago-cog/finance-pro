                        ...
                        <table className="w-full whitespace-nowrap">
                            <thead>
                                <tr className="h-6 w-full text-sm leading-none text-gray-800">
                                    ...
                                    <th className="font-semibold text-left pl-12 text-base">Preço Médio</th>
                                    <th className="font-semibold text-left pl-20 text-base">Preço Atual</th>
                                    <th className="font-semibold text-left pl-20 text-base">Variação %</th>
                                    <th className="font-semibold text-left pl-16 text-base">Total</th>
                                </tr>
                            </thead>
