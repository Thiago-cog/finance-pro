...
function RecentMoviments() {
    return (
        <>
            <div className="flex items-center justify-center pb-4">
                <div className="flex items-center justify-center pr-4">
                    <div className="md:w-96 rounded-md shadow-lg p-5  bg-white">
                        <h1 className="pt-2 pb-7 text-gray-800  font-bold text-lg">Recent Updates</h1>
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                ...
                                <p className="text-gray-600  text-sm font-medium pl-3">Order# IDO-214-152</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between pt-5">
                            <div className="flex items-center">
                                ...
                                <p className="text-gray-600  text-sm font-medium pl-3">Order# IDO-325-664</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between pt-5">
                            <div className="flex items-center">
                                ...
                                <p className="text-gray-600  text-sm font-medium pl-3">Invoice generated</p>
                            </div>
...
export default RecentMoviments;
