...
import { Bitcoin, CircleDollarSign, CandlestickChart, Building2, TrendingUp, TrendingDown, Search } from 'lucide-react';
    ...
    return (
        <>
            <div className="w-full flex items-center justify-center mb-5 ">
                ...
                <div>
                    <input className="w-96 py-2" placeholder="Search" />
                </div>
                <div>
                    <button className="bg-gradient-to-tr from-indigo-600 via-cyan-600 to-emerald-500 rounded-r-lg transform font-bold ml-0.5 px-2 py-2 text-white lg:max-w-[144px] w-full ">
                        <Search />
                    </button>
                </div>
            </div>
