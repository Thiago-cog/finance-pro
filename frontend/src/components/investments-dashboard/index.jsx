...
import { Bitcoin, CircleDollarSign, CandlestickChart, Building2 } from 'lucide-react';
                ...
                <div className="bg-white rounded py-5 pl-6 flex items-start shadow">
                    ...
                    <div className="pl-3 pr-10 mt-1">
                        ...
                        <div className="flex items-end mt-4">
                            ...
                            <p className="ml-2 mb-1 text-sm text-gray-700 dark:text-gray-500">from 2,125</p>
                        </div>
                ...
                <div className="bg-white rounded py-5 pl-6 flex items-start shadow">
                    ...
                    <div className="pl-3 pr-10 mt-1">
                        ...
                        <div className="flex items-end mt-4">
                            ...
                            <p className="ml-2 mb-1 text-sm text-gray-700 ">from 21.2%</p>
                        </div>
                        <div className="flex items-center mt-5">
                            <div className="text-green-400">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-trending-up" width={24} height={24} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="bg-white rounded py-5 pl-6 flex items-start shadow">
                    ...
                    <div className="pl-3 pr-10 mt-1">
                        ...
                        <div className="flex items-end mt-4">
                            ...
                            <p className="ml-2 mb-1 text-sm text-gray-700 ">from 2,850</p>
                        </div>
                        <div className="flex items-center mt-5">
                ...
                <div className="bg-white rounded py-5 pl-6 flex items-start shadow">
                    ...
                    <div className="pl-3 pr-10 mt-1">
                        ...
                        <div className="flex items-end mt-4">
                            ...
                            <p className="ml-2 mb-1 text-sm text-gray-700 ">from $800</p>
                        </div>
                        <div className="flex items-center mt-5">
                            <div className="text-green-400">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-trending-up" width={24} height={24} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
