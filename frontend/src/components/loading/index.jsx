    ...
    if(!disable){
        return (
            <div className="fixed bg-black bg-opacity-50 inset-0 z-50">
                <div className="fixed top-3/4 left-2/3 xl:w-2/6 xl:h-3/6 -translate-y-2/4 -translate-x-2/4">
                    <button className="inline-flex h-12 items-center justify-center gap-2.5 rounded-lg bg-primary px-6 py-3 text-3xl font-bold text-white">
                        <span>
                            <svg
